      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.inner}>
        <View style={styles.hero}>
          ...
          <ThemedText type="title" style={styles.title}>
            Manage the catalog with confidence
          </ThemedText>
          <ThemedText style={styles.subtitle}>
            Sign in to oversee products, orders, and the customer experience from a single clean
            dashboard.
          </ThemedText>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Pressable style={styles.primaryButton} onPress={handleLogin} disabled={loading}>
            {loading ? <ActivityIndicator color="#fff" /> : <Text style={styles.primaryButtonText}>Login as Admin</Text>}
          </Pressable>
